		...
		<div class="col-md-6">
			...
			<div class="form-group">
				<label>Apellido:</label> <form:input class="form-control" type="text"
					path="Apellido" placeholder="nombre" required="required"/>
			</div>
			<div class="form-group  col-md-4">
				<label>Edad:</label> <form:input class="form-control" type="text"
					path="edad" placeholder="nombre" required="required"/>
			</div>
			<div class="form-group">
				<label>Genero:</label> <form:input class="form-control" type="text"
					path="genero" placeholder="nombre" required="required"/>
			</div>

			<div class="form-group">
				<label>Estado:</label> <form:input class="form-control" type="text"
					path="estado" placeholder="nombre" required="required"/>
			</div>
			<div class="form-group">
